...
| Wall time seconds | 1366.0270 |
| Average closure time seconds | 1366.0270 |
| Average matrix time seconds | 31.9944 |
| Average engine steps | 129.0000 |
| Semantic frontier cuts | 0 |
| Source-liveness cuts | 0 |
| Delay-slot sink captures | 0 |
| Loop semantic cuts | 0 |
| Seed states tried | 10 |
...
| `constraint_projection_cache_size` | `16384` |
...
|---:|---|---:|---:|---|---|---|
| 3 | vulnerable | 4/7 | 0.6364 | nvram |  | upnpd0 -f 49152 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA AAA:AAA AAA=AAA,AAAAAAA/AAAAAAA & |
...
- Result metrics: elapsed=1366.0270s, steps=129, vectors=4/7 vulnerable/secure, coverage=0.6364
...
- Minimal bypass: `Command Substitution` vector=`$(` poc=`upnpd0 -f 49152 A$(:)AA AAA=AAA,AAAAAAA/AAAAAAA AAA:AAA AAA=AAA,AAAAAAA/AAAAAAA &`
...
- Sink/result preview: `upnpd0 -f 49152 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA AAA:AAA AAA=AAA,AAAAAAA/AAAAAAA &`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 3 | vulnerable | high | critical | direct_sink_evidence | active_empty | 1366.0270 | 129 | 4/7 | 0.6364 | strong |  | upnpd0 -f 49152 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA AAA:AAA AAA=AAA,AAAAAAA/AAAAAAA & |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_dir878_idx2_recovery_20260916_v1/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_dir878_idx2_recovery_20260916_v1/results.jsonl`
