...
| Wall time seconds | 102.8627 |
| Average closure time seconds | 102.8627 |
| Average matrix time seconds | 6.9771 |
...
- Result metrics: elapsed=102.8627s, steps=21, vectors=3/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 18 | vulnerable | high | critical | direct_sink_evidence | active_empty | 102.8627 | 21 | 3/0 | 0.0000 | strong |  | kill -9 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA.AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;rm -f /var/run/ftpc.pid  |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx17/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx17/results.jsonl`
