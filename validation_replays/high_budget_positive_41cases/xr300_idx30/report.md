...
| Wall time seconds | 50.9393 |
| Average closure time seconds | 50.9393 |
| Average matrix time seconds | 3.1002 |
| Average engine steps | 10.0000 |
...
|---:|---|---:|---:|---|---|---|
| 31 | vulnerable | 4/7 | 0.6364 | nvram |  | tc qdisc del dev A(?:A@A @"@=@"A,A@\x0a\x0a?A!/AAAA\x09AA root |
...
- Result metrics: elapsed=50.9393s, steps=10, vectors=4/7 vulnerable/secure, coverage=0.6364
...
- Sink/result preview: `tc qdisc del dev A(?:A@A @"@=@"A,A@\x0a\x0a?A!/AAAA\x09AA root`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 31 | vulnerable | high | critical | direct_sink_evidence | active_empty | 50.9393 | 10 | 4/7 | 0.6364 | strong |  | tc qdisc del dev A(?:A@A @"@=@"A,A@\x0a\x0a?A!/AAAA\x09AA root |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx30/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx30/results.jsonl`
