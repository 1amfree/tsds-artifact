...
| Wall time seconds | 307.0691 |
| Average closure time seconds | 307.0691 |
| Average matrix time seconds | 6.4934 |
...
|---:|---|---:|---:|---|---|---|
| 38 | vulnerable | 4/7 | 0.6364 | nvram |  | /opt/broken/alias.sh "A"\x09:;#A AAA=AAA,AAAAAAA/AAAAAAA" |
...
- Result metrics: elapsed=307.0691s, steps=137, vectors=4/7 vulnerable/secure, coverage=0.6364
...
- Sink/result preview: `/opt/broken/alias.sh "A"\x09:;#A AAA=AAA,AAAAAAA/AAAAAAA"`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 38 | vulnerable | high | critical | direct_sink_evidence | multi_state_settle_budget_exhausted | 307.0691 | 137 | 4/7 | 0.6364 | strong |  | /opt/broken/alias.sh "A"\x09:;#A AAA=AAA,AAAAAAA/AAAAAAA" |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx37/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx37/results.jsonl`
