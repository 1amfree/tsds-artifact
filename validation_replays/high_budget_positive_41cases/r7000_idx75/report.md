...
| Wall time seconds | 117.0051 |
| Average closure time seconds | 117.0051 |
| Average matrix time seconds | 10.7558 |
| Average engine steps | 30.0000 |
...
|---:|---|---:|---:|---|---|---|
| 76 | vulnerable | 4/0 | 0.0000 | nvram |  | rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_cfg;ftpc -u AA`:`AA AAA=AAA,AAAAAAA/AAAAAAA -p A |
...
- Result metrics: elapsed=117.0051s, steps=30, vectors=4/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_cfg;ftpc -u AA`:`AA AAA=AAA,AAAAAAA/AAAAAAA -p A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 76 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 117.0051 | 30 | 4/0 | 0.0000 | absent |  | rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_cfg;ftpc -u AA`:`AA AAA=AAA,AAAAAAA/AAAAAAA -p A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx75/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx75/results.jsonl`
