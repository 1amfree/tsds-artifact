...
| Wall time seconds | 17.1020 |
| Average closure time seconds | 17.1020 |
| Average matrix time seconds | 1.1244 |
...
- Result metrics: elapsed=17.1020s, steps=6, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 57 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 17.1020 | 6 | 11/0 | 0.0000 | absent |  | rm -f /tmp/wds_rate; wl -i eth2 sta_info :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx56/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx56/results.jsonl`
