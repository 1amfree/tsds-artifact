...
| Wall time seconds | 39.9735 |
| Average closure time seconds | 39.9735 |
| Average matrix time seconds | 1.2596 |
| Average engine steps | 100.0000 |
...
- Result metrics: elapsed=39.9735s, steps=100, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 23 | vulnerable | medium | critical | direct_sink_evidence | multi_state_settle_budget_exhausted | 39.9735 | 100 | 11/0 | 0.0000 | absent |  | echo "%s" >> /etc/chengyanconfig/</dev/nullAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac15_idx22/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac15_idx22/results.jsonl`
