...
| Wall time seconds | 16.8585 |
| Average closure time seconds | 16.8585 |
| Average matrix time seconds | 1.0447 |
...
- Result metrics: elapsed=16.8585s, steps=4, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 8 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 16.8585 | 4 | 11/0 | 0.0000 | absent |  | hostapd_cli -i:;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/asus_rt_be57_idx7/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/asus_rt_be57_idx7/results.jsonl`
