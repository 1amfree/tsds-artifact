...
| Wall time seconds | 5.1202 |
| Average closure time seconds | 5.1202 |
| Average matrix time seconds | 0.8729 |
| Average engine steps | 8.0000 |
...
- Result metrics: elapsed=5.1202s, steps=8, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 115 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 5.1202 | 8 | 11/0 | 0.0000 | absent |  | rm -f :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx114/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx114/results.jsonl`
