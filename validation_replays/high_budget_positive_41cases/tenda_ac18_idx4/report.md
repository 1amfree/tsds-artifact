...
| Wall time seconds | 38.7372 |
| Average closure time seconds | 38.7372 |
| Average matrix time seconds | 1.1867 |
...
- Result metrics: elapsed=38.7372s, steps=100, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 5 | vulnerable | medium | critical | direct_sink_evidence | multi_state_settle_budget_exhausted | 38.7372 | 100 | 11/0 | 0.0000 | absent |  | echo "%s" >> /etc/chengyanconfig/</dev/nullAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx4/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx4/results.jsonl`
