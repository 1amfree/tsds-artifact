...
| Wall time seconds | 23.2371 |
| Average closure time seconds | 23.2371 |
| Average matrix time seconds | 0.1670 |
| Average engine steps | 108.0000 |
...
|---:|---|---:|---:|---|---|---|
| 47 | vulnerable | 3/8 | 0.7273 | file |  | cfm post netctrl 51?op=1,string_info=A(@:)0( |
...
- Result metrics: elapsed=23.2371s, steps=108, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `cfm post netctrl 51?op=1,string_info=A(@:)0(`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 47 | vulnerable | high | critical | direct_sink_evidence | multi_state_settle_budget_exhausted | 23.2371 | 108 | 3/8 | 0.7273 | strong |  | cfm post netctrl 51?op=1,string_info=A(@:)0( |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac15_idx46/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac15_idx46/results.jsonl`
