...
| Wall time seconds | 35.4306 |
| Average closure time seconds | 35.4306 |
| Average matrix time seconds | 1.8833 |
...
|---:|---|---:|---:|---|---|---|
| 80 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/ftpc.pid;kill -9 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA |
...
- Result metrics: elapsed=35.4306s, steps=16, vectors=3/8 vulnerable/secure, coverage=0.7273
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 80 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 35.4306 | 16 | 3/8 | 0.7273 | weak |  | rm -f /var/run/ftpc.pid;kill -9 $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx79/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx79/results.jsonl`
