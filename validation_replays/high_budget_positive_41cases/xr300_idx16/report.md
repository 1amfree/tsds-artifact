...
| Wall time seconds | 39.8832 |
| Average closure time seconds | 39.8832 |
| Average matrix time seconds | 1.9186 |
...
|---:|---|---:|---:|---|---|---|
| 17 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/ftpc.pid;kill -9 AA.:`A. @A@=@A*,$@AA@AA/A"@(@@A |
...
- Result metrics: elapsed=39.8832s, steps=16, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /var/run/ftpc.pid;kill -9 AA.:`A. @A@=@A*,$@AA@AA/A"@(@@A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 17 | vulnerable | high | critical | direct_sink_evidence | active_empty | 39.8832 | 16 | 3/8 | 0.7273 | strong |  | rm -f /var/run/ftpc.pid;kill -9 AA.:`A. @A@=@A*,$@AA@AA/A"@(@@A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx16/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx16/results.jsonl`
