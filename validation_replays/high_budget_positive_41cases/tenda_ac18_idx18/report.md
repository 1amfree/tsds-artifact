...
| Wall time seconds | 22.0068 |
| Average closure time seconds | 22.0068 |
| Average matrix time seconds | 1.0075 |
...
- Result metrics: elapsed=22.0068s, steps=7, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 19 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 22.0068 | 7 | 11/0 | 0.0000 | absent |  | mv </dev/nullAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx18/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx18/results.jsonl`
