...
| Wall time seconds | 16.2792 |
| Average closure time seconds | 16.2792 |
| Average matrix time seconds | 1.0262 |
...
- Result metrics: elapsed=16.2792s, steps=6, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 95 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 16.2792 | 6 | 11/0 | 0.0000 | absent |  | rm -f /tmp/wds_rate; wl sta_info :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx94/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx94/results.jsonl`
