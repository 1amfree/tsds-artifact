...
| Wall time seconds | 10.2560 |
| Average closure time seconds | 10.2560 |
| Average matrix time seconds | 0.2838 |
...
|---:|---|---:|---:|---|---|---|
| 20 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /tmp/wget-log-upnp-finfo /var/run/wget.pid;kill -9 @$@:`A |
...
- Result metrics: elapsed=10.2560s, steps=16, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /tmp/wget-log-upnp-finfo /var/run/wget.pid;kill -9 @$@:`A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 20 | vulnerable | high | critical | direct_sink_evidence | active_empty | 10.2560 | 16 | 3/8 | 0.7273 | strong |  | rm -f /tmp/wget-log-upnp-finfo /var/run/wget.pid;kill -9 @$@:`A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx19/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx19/results.jsonl`
