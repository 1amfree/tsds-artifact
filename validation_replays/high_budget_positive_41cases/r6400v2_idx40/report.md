...
| Wall time seconds | 16.1908 |
| Average closure time seconds | 16.1908 |
| Average matrix time seconds | 1.1385 |
...
|---:|---|---:|---:|---|---|---|
| 41 | vulnerable | 11/0 | 0.0000 | entry_arg |  | rm -f /tmp/wds_rate; wl sta_info </dev/nullAAAAAAAAAAAAAAAAAAAAA |
...
- Result metrics: elapsed=16.1908s, steps=6, vectors=11/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `rm -f /tmp/wds_rate; wl sta_info </dev/nullAAAAAAAAAAAAAAAAAAAAA`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 41 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 16.1908 | 6 | 11/0 | 0.0000 | absent |  | rm -f /tmp/wds_rate; wl sta_info </dev/nullAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx40/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx40/results.jsonl`
