...
| Wall time seconds | 101.0493 |
| Average closure time seconds | 101.0493 |
| Average matrix time seconds | 7.3525 |
...
|---:|---|---:|---:|---|---|---|
| 130 | vulnerable | 4/0 | 0.0000 | nvram |  | rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_tbl;ftpc -u $$(:)\x09\x0a @A@=@@A,@@@A\x09A\x09/@@AA@"@ -p A |
...
- Result metrics: elapsed=101.0493s, steps=13, vectors=4/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_tbl;ftpc -u $$(:)\x09\x0a @A@=@@A,@@@A\x09A\x09/@@AA@"@ -p A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 130 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 101.0493 | 13 | 4/0 | 0.0000 | absent |  | rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_tbl;ftpc -u $$(:)\x09\x0a @A@=@@A,@@@A\x09A\x09/@@AA@"@ -p A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx129/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx129/results.jsonl`
