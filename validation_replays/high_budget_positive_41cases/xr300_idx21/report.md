...
| Wall time seconds | 55.1735 |
| Average closure time seconds | 55.1735 |
| Average matrix time seconds | 2.9007 |
...
|---:|---|---:|---:|---|---|---|
| 22 | vulnerable | 4/7 | 0.6364 | nvram |  | kill -9 AA\x09:AAA AAA=AAA,AAAAAAA/AAAAAAA |
...
- Result metrics: elapsed=55.1735s, steps=21, vectors=4/7 vulnerable/secure, coverage=0.6364
...
- Sink/result preview: `kill -9 AA\x09:AAA AAA=AAA,AAAAAAA/AAAAAAA`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 22 | vulnerable | high | critical | direct_sink_evidence | active_empty | 55.1735 | 21 | 4/7 | 0.6364 | strong |  | kill -9 AA\x09:AAA AAA=AAA,AAAAAAA/AAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx21/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx21/results.jsonl`
