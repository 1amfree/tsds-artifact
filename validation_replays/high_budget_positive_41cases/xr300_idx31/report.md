...
| Wall time seconds | 18.6483 |
| Average closure time seconds | 18.6483 |
| Average matrix time seconds | 0.6952 |
...
|---:|---|---:|---:|---|---|---|
| 32 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $AA:AAA AAA=A |
...
- Result metrics: elapsed=18.6483s, steps=18, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $AA:AAA AAA=A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 32 | vulnerable | high | critical | direct_sink_evidence | active_empty | 18.6483 | 18 | 3/8 | 0.7273 | strong |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $AA:AAA AAA=A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx31/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx31/results.jsonl`
