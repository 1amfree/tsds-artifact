...
| Wall time seconds | 17.5538 |
| Average closure time seconds | 17.5538 |
| Average matrix time seconds | 0.9756 |
...
|---:|---|---:|---:|---|---|---|
| 131 | vulnerable | 11/0 | 0.0000 | entry_arg |  | wl -i :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |
...
- Result metrics: elapsed=17.5538s, steps=6, vectors=11/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `wl -i :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 131 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 17.5538 | 6 | 11/0 | 0.0000 | absent |  | wl -i :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx130/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx130/results.jsonl`
