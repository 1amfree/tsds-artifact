...
| Wall time seconds | 24.1089 |
| Average closure time seconds | 24.1089 |
| Average matrix time seconds | 1.0369 |
| Average engine steps | 32.0000 |
...
|---:|---|---:|---:|---|---|---|
| 83 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 A$(:)AA AAA=A |
...
- Result metrics: elapsed=24.1089s, steps=32, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 A$(:)AA AAA=A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 83 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 24.1089 | 32 | 3/8 | 0.7273 | weak |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 A$(:)AA AAA=A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx82/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx82/results.jsonl`
