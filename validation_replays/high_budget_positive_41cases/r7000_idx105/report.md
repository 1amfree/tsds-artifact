...
| Wall time seconds | 16.5726 |
| Average closure time seconds | 16.5726 |
| Average matrix time seconds | 1.1607 |
...
- Result metrics: elapsed=16.5726s, steps=6, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 106 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 16.5726 | 6 | 11/0 | 0.0000 | absent |  | rm -f /tmp/wds_signal; wl -i eth2 rssi :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx105/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx105/results.jsonl`
