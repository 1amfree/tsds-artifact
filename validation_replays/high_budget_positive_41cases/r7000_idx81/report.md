...
| Wall time seconds | 17.6540 |
| Average closure time seconds | 17.6540 |
| Average matrix time seconds | 0.6258 |
| Average engine steps | 18.0000 |
...
|---:|---|---:|---:|---|---|---|
| 82 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $$@:`0< .AA=$ |
...
- Result metrics: elapsed=17.6540s, steps=18, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $$@:`0< .AA=$`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 82 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 17.6540 | 18 | 3/8 | 0.7273 | weak |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $$@:`0< .AA=$ |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx81/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx81/results.jsonl`
