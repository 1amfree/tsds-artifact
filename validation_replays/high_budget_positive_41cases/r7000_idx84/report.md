...
| Wall time seconds | 36.4229 |
| Average closure time seconds | 36.4229 |
| Average matrix time seconds | 1.9852 |
...
|---:|---|---:|---:|---|---|---|
| 85 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/wget.pid /tmp/wget-log-db-gui;kill -9 $A-:@($ AA@="A@,A@%.A%@/"A@*.@A |
...
- Result metrics: elapsed=36.4229s, steps=16, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `rm -f /var/run/wget.pid /tmp/wget-log-db-gui;kill -9 $A-:@($ AA@="A@,A@%.A%@/"A@*.@A`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 85 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 36.4229 | 16 | 3/8 | 0.7273 | weak |  | rm -f /var/run/wget.pid /tmp/wget-log-db-gui;kill -9 $A-:@($ AA@="A@,A@%.A%@/"A@*.@A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx84/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx84/results.jsonl`
