...
| Wall time seconds | 3.8674 |
| Average closure time seconds | 3.8674 |
| Average matrix time seconds | 0.9079 |
| Average engine steps | 4.0000 |
...
|---:|---|---:|---:|---|---|---|
| 4 | vulnerable | 11/0 | 0.0000 | entry_arg |  | :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |
...
- Result metrics: elapsed=3.8674s, steps=4, vectors=11/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `:;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 4 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 3.8674 | 4 | 11/0 | 0.0000 | absent |  | :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/asus_rt_be57_idx3/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/asus_rt_be57_idx3/results.jsonl`
