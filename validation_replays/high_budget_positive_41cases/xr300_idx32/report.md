...
| Wall time seconds | 25.3409 |
| Average closure time seconds | 25.3409 |
| Average matrix time seconds | 1.0054 |
...
|---:|---|---:|---:|---|---|---|
| 33 | vulnerable | 3/8 | 0.7273 | file |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $<A:@@0 <A@=$ |
...
- Result metrics: elapsed=25.3409s, steps=32, vectors=3/8 vulnerable/secure, coverage=0.7273
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 33 | vulnerable | high | critical | direct_sink_evidence | active_empty | 25.3409 | 32 | 3/8 | 0.7273 | strong |  | rm -f /var/run/wget.pid /var/run/wget.pid;kill -9 $<A:@@0 <A@=$ |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx32/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx32/results.jsonl`
