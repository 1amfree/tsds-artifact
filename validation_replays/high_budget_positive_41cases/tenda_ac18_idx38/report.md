...
| Wall time seconds | 22.6145 |
| Average closure time seconds | 22.6145 |
| Average matrix time seconds | 0.1615 |
...
|---:|---|---:|---:|---|---|---|
| 39 | vulnerable | 3/8 | 0.7273 | file |  | cfm post netctrl 51?op=1,string_info=A@@:)@( |
...
- Result metrics: elapsed=22.6145s, steps=108, vectors=3/8 vulnerable/secure, coverage=0.7273
...
- Sink/result preview: `cfm post netctrl 51?op=1,string_info=A@@:)@(`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 39 | vulnerable | high | critical | direct_sink_evidence | multi_state_settle_budget_exhausted | 22.6145 | 108 | 3/8 | 0.7273 | strong |  | cfm post netctrl 51?op=1,string_info=A@@:)@( |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx38/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/tenda_ac18_idx38/results.jsonl`
