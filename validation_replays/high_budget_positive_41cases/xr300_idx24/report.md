...
| Wall time seconds | 42.1474 |
| Average closure time seconds | 42.1474 |
| Average matrix time seconds | 2.1755 |
...
- Result metrics: elapsed=42.1474s, steps=16, vectors=3/8 vulnerable/secure, coverage=0.7273
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 25 | vulnerable | high | critical | direct_sink_evidence | active_empty | 42.1474 | 16 | 3/8 | 0.7273 | strong |  | rm -f /var/run/wget.pid /tmp/wget-log-db-gui;kill -9 A$(:)AA AAA=AAA,AAAAAAA/AAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx24/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx24/results.jsonl`
