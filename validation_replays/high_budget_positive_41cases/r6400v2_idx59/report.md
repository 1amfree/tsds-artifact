...
| Wall time seconds | 4.9790 |
| Average closure time seconds | 4.9790 |
| Average matrix time seconds | 0.8604 |
...
- Result metrics: elapsed=4.9790s, steps=8, vectors=11/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 60 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 4.9790 | 8 | 11/0 | 0.0000 | absent |  | rm -f :;:;#AAAAAAAAAAAAAAAAAAAAAAAAAA |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx59/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r6400v2_idx59/results.jsonl`
