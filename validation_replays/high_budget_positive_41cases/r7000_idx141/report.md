...
| Wall time seconds | 17.3505 |
| Average closure time seconds | 17.3505 |
| Average matrix time seconds | 1.0377 |
| Average engine steps | 22.0000 |
...
|---:|---|---:|---:|---|---|---|
| 142 | vulnerable | 11/0 | 0.0000 | entry_arg |  | md5sum :{{\x0aA}>:d P& A\x09\x09!AA ! *Aa\x0a \x0a!A\x0a |
...
- Result metrics: elapsed=17.3505s, steps=22, vectors=11/0 vulnerable/secure, coverage=0.0000
...
- Sink/result preview: `md5sum :{{\x0aA}>:d P& A\x09\x09!AA ! *Aa\x0a \x0a!A\x0a`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 142 | vulnerable | medium | critical | direct_sink_evidence | active_empty | 17.3505 | 22 | 11/0 | 0.0000 | absent |  | md5sum :{{\x0aA}>:d P& A\x09\x09!AA ! *Aa\x0a \x0a!A\x0a |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx141/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/r7000_idx141/results.jsonl`
