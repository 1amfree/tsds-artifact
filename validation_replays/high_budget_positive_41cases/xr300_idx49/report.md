...
| Wall time seconds | 93.5055 |
| Average closure time seconds | 93.5055 |
| Average matrix time seconds | 6.6680 |
| Average engine steps | 13.0000 |
...
- Result metrics: elapsed=93.5055s, steps=13, vectors=4/0 vulnerable/secure, coverage=0.0000
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| 50 | vulnerable | high | critical | direct_sink_evidence | active_empty | 93.5055 | 13 | 4/0 | 0.0000 | strong |  | rm -f /var/run/ftpc.pid /tmp/ftpc.err /tmp/lang_tbl;ftpc -u $AA:AAA AAA=AAA,AAAAAAA/AAAAAAA -p A |

## Output Artifacts

- Summary JSON: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx49/summary.json`
- Per-closure JSONL: `/home/ubuntu/work/sanitizer/experiment_reports/iceccs_high_budget_positive_full_20260916/xr300_idx49/results.jsonl`
